...
strRcpt = "allthiscrap@gmail.com" 'PUT THE ADDRESS YOU WANT THE FORM SENT TO HERE



strFromVar = "email" 'IF YOU WANT THE REPLY-TO ADDRESS OF THE EMAIL TO BE 

'TAKEN FROM THE FORM, PUT THE NAME OF THE INPUT ITEM HERE



strDefFrom = "allthiscrap@gmail.com" 'PUT A DEFAULT, EVEN FAKE, From ADDRESS HERE



strDefSubject = "Ashburn Town Comments" 'PUT THE SUBJECT OF THE EMAIL HERE. 

'IF AN INPUT ITEM ON THE FORM IS CALLED SUBJECT, IT WILL BE USED INSTEAD



strRedirect = "http://stu.aii.edu/~yourid/imd220/foldername/addressofpage.htm" 'URL TO REDIRECT TO AFTER A SUCCESSFUL FORM SUBMISSION.

'IF AN INPUT ITEM CALLED REDIRECT EXISTS IN THE FORM, ITS VALUE WILL BE USED INSTEAD
